...
public class EngineDistanceSensor implements Callable<Void> {
    public static final String TOPIC = "esp/distancia";
    private IMqttClient client;
    private Random rnd = new Random();

    public EngineDistanceSensor(IMqttClient client){
        this.client = client;
    }

    public Void call() throws Exception {
        MqttMessage msg = readEngineDist();
        msg.setQos(0);
    ...
    private MqttMessage readEngineDist(){
